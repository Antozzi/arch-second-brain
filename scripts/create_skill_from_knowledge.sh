...
# --- промпт ---
PROMPT="Ты извлекаешь доменную экспертизу из архитектурных документов проекта для создания AI-скилла.
...
Фокус: что это за система/технология/домен, как она работает, какие правила предметной области.
...
## WHEN_TO_USE
- [когда этот скилл нужен при заполнении документов по данному проекту]
...
## CORE_CONCEPTS
- **[Термин/система]**: [определение — 1 строка, из контекста проекта]
- **[Термин/система]**: [определение — 1 строка]

## BUSINESS_RULES
- [Правило предметной области из документов]
- [Ограничение или требование домена]
